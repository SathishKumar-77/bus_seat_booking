...
const Home = () => {
  ...
  const popularRoutes = [
    { from: 'Dhaka', to: 'Chittagong', price: '৳1200', duration: '6h' },
    { from: 'Dhaka', to: 'Sylhet', price: '৳1000', duration: '5h' },
    { from: 'Dhaka', to: 'Khulna', price: '৳1500', duration: '8h' },
    { from: 'Dhaka', to: 'Rajshahi', price: '৳1100', duration: '7h' }
  ]
